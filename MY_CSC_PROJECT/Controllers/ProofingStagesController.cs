...
namespace MY_CSC_PROJECT.Controllers
{
    public class ProofingStagesController : Controller
    {
        ...
        public ProofingStagesController(MY_CSC_PROJECTContext context, PermissionService permissionService)
        {
            _context = context;
            ...
            if (docs != null)
            {
                switch (docs.Status)
                {
                    case StatusType.ProofingStage:
                        ...
                        docs.Remarks = "N/A";
                        docs.Status = StatusType.PostingStage;
